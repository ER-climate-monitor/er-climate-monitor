...
interface SensorOperations {
     ...
     * @param {Record<string, string>} _headers - Input headers that will be redirected to the sensor registry;
     * @param {object} _body - Input sensor information;
     * @returns {Promise<HttpResponse>} Sensor registry response.
     */
    registerOperation(_endpointPath: string, _headers: Record<string, string>, _body: object): Promise<HttpResponse>;
    /**
     ...
     * @returns {Promise<HttpResponse>} Sensor registry response.
     */
    getAllSensorsOperation(_endpointPath: string, _headers: Record<string, string>): Promise<HttpResponse>;
    /**
     ...
     * @returns {Promise<HttpResponse>} Sensor registry response.
     */
    deleteOperation(_endpointPath: string, _headers: Record<string, string>): Promise<HttpResponse>;
    /**
...
class SensorService<T extends HttpClient> extends AbstractService<T> implements SensorOperations {
    ...
    registerOperation(endpointPath: string, headers: any, body: object): Promise<HttpResponse> {
    ...
    getAllSensorsOperation(endpointPath: string, headers: any): Promise<HttpResponse> {
        const request = new BasicHttpRequest(HttpMethods.GET, endpointPath, headers, {}, {}, {});
        return this.circuitBreaker.fireRequest(this.endpoint, request);
    }

    deleteOperation(endpointPath: string, headers: any): Promise<HttpResponse> {
